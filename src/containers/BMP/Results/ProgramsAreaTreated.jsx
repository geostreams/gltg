  ...
  props.data.forEach((d) => {
    ...
    if (tableData[boundaryId]) {
      tableData[boundaryId][d.program] =
        (tableData[boundaryId][d.program] || 0) + (d["area_treated-sum"] || 0);
    } else {
  ...
  return (
    <>
      <Typography variant="body1" paragraph>
        Distribution of the number of acres treated by conservation practices
        across selected area by year. Conservation practices are distinguished
        by funding source. Please see this document for more information about
        assumptions made to estimate acres treated:&nbsp;
        <a
      ...
      <TableContainer className={classes.tableContainer}>
        <Table stickyHeader>
          <TableHead>
            ...
            <TableRow>
              <TableCell />
              <TableCell colSpan={programs.length} align="center">
                Acres
              </TableCell>
            </TableRow>
          </TableHead>
...
ProgramsAreaTreated.defaultProps = {
