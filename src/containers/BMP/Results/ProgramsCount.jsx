  ...
  props.data.forEach((d) => {
    ...
    if (tableData[boundaryId]) {
      tableData[boundaryId][d.program] =
        (tableData[boundaryId][d.program] || 0) + (d["program-count"] || 0);
    } else {
  ...
  return (
    <>
      <Typography variant="body1" paragraph>
        Distribution of the number of total conservation practices across
        selected area by year. Conservation practices are distinguished by
        funding source.
      </Typography>
      <VegaLite
