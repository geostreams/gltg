...
const DataStories = () => {
  ...
  return (
    <>
      ...
      <Alert severity="info">
        Below, please find our archive of storyboards providing historical
        context on nutrient pollution and the Great Lakes to Gulf project. Our
        team is at work developing additional resources to launch in late 2022
