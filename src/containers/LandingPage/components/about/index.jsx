    ...
    <Box className={classes.introBox}>
      ...
      <div style={{ marginLeft: "3em", width: "90%" }}>
        <Typography className={classes.introSubtitle} gutterBottom>
          The Great Lakes to Gulf Virtual Observatory (GLTG) is an interactive
          application that provides user-friendly access to water quality
          information about the Mississippi River and its tributaries. Users
          can:
        </Typography>
      </div>
      <div style={{ marginLeft: "7em", marginTop: "1em", width: "80%" }}>
        <Typography className={classes.introList} gutterBottom>
          <ul>
            <li>
              Select and compare current and historic water quality conditions
              in rivers and streams.
            </li>
            <li>Analyze and graph specific parameters.</li>
            <li>
              Examine data layers contributing to observed water quality - such
              as land cover, rainfall, and more.
            </li>
      ...
      <div style={{ marginLeft: "3em", marginTop: "1em", width: "90%" }}>
        <Typography className={classes.introSubtitle} gutterBottom>
          GLTG helps people visualize and better understand nutrient pollution
          and its potential causes. Find out more and try it out for yourself
