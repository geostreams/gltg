        ...
        <>
            <div className={classes.textDiv}>
                ...
                <div className={classes.row} >
                    ...
                    <div className={classes.column} style={{ background: `url(${image1})`, backgroundRepeat: 'no-repeat', backgroundSize: 'cover' }} />
                    <div className={classes.column} style={{ background: `url(${image2})`, backgroundRepeat: 'no-repeat', backgroundSize: 'cover' }} />
                    <div className={classes.column} style={{ background: `url(${image3})`, backgroundRepeat: 'no-repeat', backgroundSize: 'cover' }} />
