	...
	return (
		<>
			...
			<TextBox
				...
				text="GLTG dashboards provide Mississippi River water quality analyses that have been developed by our team of experts. Take in the big picture at the summary dashboard; review water quality state-by-state; and see the impact of a variety of best management practices on the river."
			/>
			<Imagerow
			...
			/>
			<TextBox
				title="Explore GeoStreaming Dashboards"
				text="GLTG is built on Geodashboards, an open-source web technology that lets users interact with and visualize geospatial data. Use the dashboards below to explore, download, and perform your own analysis on water quality data from across the Mississippi River watershed."
			/>
			<Imagerow
				image1={Explore}
				image2={Analyze}
				image3={Download}
				header1={secondRowHeader1}
				header2={secondRowHeader2}
				header3={secondRowHeader3}
				subheader1={secondRowSubHeader1}
				subheader2={secondRowSubHeader2}
				subheader3={secondRowSubHeader3}
				link1={secondRowLink1}
				link2={secondRowLink2}
				link3={secondRowLink3}
			/>
