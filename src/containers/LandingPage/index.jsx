...
const Home = () => {
    ...
    const firstRowHeader1 = 'Trends Dashboard';
    ...
    return (
        <>
            <About />
            <RssFeed></RssFeed>
            <TextBox title = 'Explore GLTG Dashboards' text = 'GLTG dashboards provide Mississippi River water quality analyses that have been developed by our team of experts. Take in the big picture at the Trends Dashboard; review water quality state-by-state; and see the impact of a variety of best management practices on the river.' />
            <Imagerow image1 = {SummaryDashboard} image2 = {StatePortal} image3 ={ConservationPractices}
                ...
                link1={firstRowLink1} link2={firstRowLink2} link3={firstRowLink3} link4={illinois} link5={arkansas} link6={iowa} link7={indiana} link8={missouri} link9={tennessee}/>
