      ...
      <Container ref={container}>
        ...
        featureId === "Statewide Summary" ? (
          <>
            ...
            <Typography variant="subtitle1">
              TOTAL {selectedNutrient.toUpperCase()} LOAD LEAVING THE STATE OF
              ILLINOIS
            </Typography>
            <Typography variant="caption">
              The total {selectedNutrient} load leaving the state of Illinois is
              estimated to be&nbsp;
            ...
            <BarChart
              ...
              barsData={Object.entries(
                overallData.drainage.annual_load[selectedNutrient],
              ).map(([year, value]) => ({
                x: +year,
                y: +value,
                selected: +year === +selectedYear,
              ...
              barStroke={(d) =>
                yearsOptions.length && d.selected ? "red" : "#117fc9"
              }
              barStrokeWidth={2}
          ...
          <>
            ...
            <Container>
              <LegendHorizontalDiscrete
                ...
                activeBoxLabel={
                  featureValue >= 0 ? featureValue.toString() : " "
                }
          ...
          <>
            ...
            >
              <Box display="flex" alignItems="center">
                ...
                {annualYieldChartData[annualYieldChartData.length - 1].x}
                &nbsp;
                <InfoIcon
                  className={`actionIcon ${classes.infoIcon}`}
            ...
            <BarChart
              ...
              barFill={({ y }) => {
                const styleInfo =
                  FEATURE_STYLE_INFO[getNutrientValueCategoryIndex(y)];
              ...
              mouseOut={(d, idx, rects) => {
                const styleInfo =
                  FEATURE_STYLE_INFO[getNutrientValueCategoryIndex(d.y)];
        ...
        {selectedBoundary === "drainage" || selectedBoundary === "huc8" ? (
          <Typography variant="subtitle2" align="center" gutterBottom>
            ...
            >
              Illinois Nutrient Reduction Strategy Science Assessment Update
              2019
            </a>
          </Typography>
        ) : null}
