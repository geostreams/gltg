						...
						<Box className={classes.legendBox}>
							...
							<div className={classes.legendContainer}>
								...
								<div className={classes.legendFooter}>
									<span>
										{" "}
										<sup>*</sup> Percentage ranges represent
										the probability that the trend is
										upwards
									</span>
								</div>
							</div>
						...
						<div>
							{data && (
								<Box className={classes.chart}>
									<h4 className={classes.chartHeader}>
										Flux Graph
									</h4>
									<SummaryGraph
